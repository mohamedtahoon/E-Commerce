<%-- 
    Document   : CommonFooter
    Created on : Feb 22, 2019, 12:40:59 AM
    Author     : Abdo Amin
--%>
...
<div id="footerSection">
    <div class="container">
        <div class="row">
            <div class="span3">
                <h5>ACCOUNT</h5>
                <a href="${pageContext.request.contextPath}/user_profile.jsp">YOUR ACCOUNT</a>
                <a href="${pageContext.request.contextPath}/special_offer.jsp">DISCOUNT</a>
            </div>
            <div class="span3">
                <h5>INFORMATION</h5>
            ...
            <div class="span3">
                <h5>OUR OFFERS</h5>
                <a href="${pageContext.request.contextPath}/index.jsp">NEW PRODUCTS</a>
                <a href="${pageContext.request.contextPath}/special_offer.jsp">SPECIAL OFFERS</a>
            </div>
            <div id="socialMedia" class="span3 pull-right">
                <h5>SOCIAL MEDIA </h5>
                <a href="https://www.facebook.com"><img width="60" height="60" src="themes/images/facebook.png" title="facebook"
                                 alt="facebook" /></a>
                <a href="https://twitter.com"><img width="60" height="60" src="themes/images/twitter.png" title="twitter"
                                 alt="twitter" /></a>
                <a href="https://www.youtube.com"><img width="60" height="60" src="themes/images/youtube.png" title="youtube"
                                 alt="youtube"/></a>
            </div>
